/*
    ...
    This is a program that parses through a CSV file consisting of data regarding
    airline routes and enables the user to search statistics based on their choice.
    This is the header file which declares the struct Routerecord, the enum SearchType 
    and the prototypes for the functions.
